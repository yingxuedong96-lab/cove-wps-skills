...
📄 源文档：样式提取.docx
📑 文档类型：论文报告样式
📊 共提取 10 种样式，扫描 200 个段落

## 样式详情

| 样式名称 | 出现次数 | 字体 | 字号 | 加粗 | 对齐 | 首行缩进 | 行距 |
|---------|---------|------|------|------|------|---------|------|
| 论文标题 | 1处 | 黑体 | 22pt | 是 | 居中 | - | - |
| 一级标题 | 5处 | 黑体 | 16pt | 是 | 左对齐 | - | - |
| 正文 | 150处 | 宋体 | 12pt | 否 | 两端对齐 | 2.0字符 | 22.0pt |
...
**重要：必须从 stylesTable 字段提取数据，用Markdown表格展示每种样式的具体参数！**
